...
#                 tokens_list.append(
#                     self.task.source_dictionary.encode_line(
#                         str(prefix + text_spans_bpe + ROBERTA_END_SENTENCE).strip(), append_eos=False
#                     )
#                 )
#                 print(str(prefix + text_spans_bpe + ROBERTA_END_SENTENCE).strip())
#                 print(tokens_list)
...
#             tokens = torch.cat(tokens_list)[: self.max_sentence_length]
            ...
            for x in masked_index:
                tmp_a.append(x[0])
            masked_indices_list.append(tmp_a)
